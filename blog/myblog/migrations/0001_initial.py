    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifile_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(upload_to='bannner/', verbose_name='轮播图')),
        ...
        migrations.AddField(
            model_name='article',
            name='tui',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='myblog.Tui', verbose_name='推荐位'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
